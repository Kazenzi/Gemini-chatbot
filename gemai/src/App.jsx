  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios.post(
        "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=KEY HERE ",
        {
    ...
    <div className="bg-gray-100 h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6 flex flex-col">
        <a href="https://github.com/Vishesh-Pandey/chat-ai" target="_blank">
          <h1 className="text-4xl font-bold text-center mb-6">Chat AI</h1>
        </a>
        ...
        <form onSubmit={generateAnswer} className="flex">
          <textarea
            required
            className="border border-gray-300 rounded w-full p-4 mr-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
            value={question}
